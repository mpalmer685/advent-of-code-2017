...
const { part1, part2 } = require('../puzzles/day7')
...
describe('Day 7', () => {
    describe('Part 1', () => {
        testSolution({
            solution: part1,
            inputs: [sampleInput, readFileSync('./input/day7', 'utf8')],
            expectedOutputs: ['tknk', 'svugo']
        })
    })
    ...
    describe('Part 2', () => {
        testSolution({
            solution: part2,
            inputs: [sampleInput, otherInput],
            expectedOutputs: [60, 299]
        })
    })
})
